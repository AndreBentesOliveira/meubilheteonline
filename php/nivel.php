...
<form method="POST" action="nivelphp.php" class="form-style-9">
	...
	$busca_query = mysql_query("SELECT nivel FROM `cadastro`")or die(mysql_error());
?>                                        
                                            <select name="nivel" id="nivel" class="field-style" >
